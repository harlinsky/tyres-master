...
/* eof ^^^ */
  ...
  (function($) {
    ...
    function active() {
      $(".col-mid__form-btn").on("click", function() {
    ...
    if($('body').is('.page-index')){
      $('.col-mid__form-btn').click(function(e){
    ...
    if($('body').is('.page-promo-item')){
      $('.order-send__right-btn').click(function(e){
        $(this).addClass('load-more--loading');
        setTimeout(function(e){
          $('.load-more--loading').removeClass('load-more--loading')
        }, 2000);
    ...
    if($('body').is('.page-search')){
      $('.search-form__send-btn').click(function(e){
        $(this).addClass('load-more--loading');
        setTimeout(function(e){
          $('.load-more--loading').removeClass('load-more--loading')
        }, 2000);
    ...
    if($('body').is('.page-product')){
      $('.btn-send, .form-send__init .btn').click(function(e){
        $(this).addClass('load-more--loading');
        setTimeout(function(e){
          $('.load-more--loading').removeClass('load-more--loading')

          //- show next block:
          $('.form-send .front-end').fadeOut(300);
          $('.form-send .back-end').fadeIn(300);
        }, 2000);
    ...
    if($('body').is('.page-BLANKBLANKBLANKBLANK')){
      $('.BTNblankBTNblank').click(function(e){
        $(this).addClass('load-more--loading');
        setTimeout(function(e){
          $('.load-more--loading').removeClass('load-more--loading')
        }, 2000);
